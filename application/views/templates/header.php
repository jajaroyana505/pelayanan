    ...
    <nav class="navbar bg-success ">
        ...
        <div class="container container-fluid">
            ...
            <nav class="nav text-light">
                <a class="nav-link text-light" href="<?php echo base_url() ?>user/beranda">Beranda</a>
                <a class="nav-link text-light" href="<?php echo base_url() ?>user/pengajuan">Pengajuan</a>
                <a class="nav-link text-light" href="<?php echo base_url() ?>user/pengaduan">Pengaduan</a>
                <a class="nav-link text-light" href="<?php echo base_url() ?>user">Profile</a>
